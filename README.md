...
This driver is based on the (latest) official and manufacturer supported Realtek v5.11.2.3 driver with fixes and improvements to support the latest kernels (>=5, up to 7.1).
