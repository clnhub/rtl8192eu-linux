...
This driver is based on the (latest) manufacturer supported Realtek v5.6.3.1 driver with fixes and improvements to support the latest kernels (up to 5.18).
