...
#else
                                                        memcpy((u8 *)(tag + 1) + MAGIC_CODE_LEN + RTL_RELAY_TAG_LEN,
                                                        (u8 *)(pOldTag + 1), old_tag_len);
#endif
...
#else
                                                memcpy((u8 *)(tag + 1) + MAGIC_CODE_LEN, skb->data + ETH_ALEN, ETH_ALEN);
#endif
...
#else
                                        memcpy(skb->data, (u8 *)(tag + 1) + MAGIC_CODE_LEN, ETH_ALEN);
#endif
